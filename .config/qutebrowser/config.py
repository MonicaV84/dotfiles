...
theme = 'base16-nord.py'  # Or whichever you prefer
config.source(os.path.expanduser(f'~/.config/qutebrowser/themes/themes/default/base16-nord.config.py'))
...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/moni/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/moni/.local/share/qutebrowser/userscripts/*')
